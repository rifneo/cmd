...
var Viewer = function Viewer(_ref) {
    ...
    return _react2['default'].createElement('iframe', { src: url, style: _extends({}, style, { height: "100%", border: 0, flex: 1 }), className: 'vertical_fit' });
};
...
var Editor = (function (_React$Component) {
    ...
    _createClass(Editor, [{
        ...
        value: function componentWillUnmount() {
            ...
            pydio.ApiClient.request({ get_action: 'retrieve_from_zohoagent' }, function (_ref2) {
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(Viewer, _extends({}, this.props, { url: url }));
        }
    }]);
