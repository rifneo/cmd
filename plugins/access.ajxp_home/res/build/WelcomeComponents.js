...
var DlAppsPanel = (function (_React$Component) {
    ...
    _createClass(DlAppsPanel, [{
        ...
        value: function render() {
            var configs = this.props.pydio.getPluginConfigs('access.ajxp_home');
            var mobileBlocks = [],
                syncBlocks = [];
...
var AltDashboard = React.createClass({
    ...
    render: function render() {
        ...
        var uWidgetProps = this.props.userWidgetProps || {};
        var wsListProps = this.props.workspacesListProps || {};
        ...
        var widgetBarEnabled = !!!this.props.pydio.getPluginConfigs('access.ajxp_home').get('DISABLE_WIDGET_BAR');
        ...
        return React.createElement(
            ...
            wTourEnabled && !guiPrefs['WelcomeComponent.Pydio8.TourGuide.Welcome'] && React.createElement(_WelcomeTour2['default'], { ref: 'welcome', pydio: this.props.pydio }),
            ...
            React.createElement(
                ...
                React.createElement(
                    _materialUi.Paper,
                    { zDepth: 0, style: styles.appBarStyle, rounded: false },
                    React.createElement(
                        'div',
                        ...
                        React.createElement(
                            ...
                            React.createElement(_materialUi.IconButton, { style: { color: 'white' }, iconClassName: 'mdi mdi-menu', onTouchTap: this.openDrawer })
                        ),
                        React.createElement('span', { style: { flex: 1 } }),
                        React.createElement(
                            'div',
                            { style: { textAlign: 'center', width: 260 } },
                            React.createElement(_ConfigLogo2['default'], {
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        _extends({ zDepth: 2 }, this.props, { style: styles.wsListsContainerStyle }),
                        React.createElement(
                            'div',
                            ...
                            React.createElement(
                                ...
                                pydio.MessageHash['user_home.87']
                            ),
                            React.createElement(_recentRecentAccessCard2['default'], _extends({}, this.props, {
                    ...
                    widgetBarEnabled && React.createElement(PydioComponents.DynamicGrid, {
...
},{"../recent/RecentAccessCard":14,"../workspaces/WorkspacesListCard":17,"./ConfigLogo":6,"./HomeSearchForm":8,"./WelcomeTour":10,"color":"color","material-ui":"material-ui","pydio":"pydio","react":"react"}],8:[function(require,module,exports){
/*
 * Copyright 2007-2017 Charles du Jeu - Abstrium SAS <team (at) pyd.io>
 * This file is part of Pydio.
 *
...
var WidgetsCard = function WidgetsCard(props) {
    ...
    return React.createElement(
        ...
        React.createElement(
            Scheme,
            null,
            React.createElement('img', { src: 'plugins/access.ajxp_home/res/images/movecards.gif', style: { height: 70, margin: '15px 30px' } })
        )
    );
};
...
var WelcomeTour = (function (_Component2) {
    ...
    _createClass(WelcomeTour, [{
            ...
            if (!this.state.started) {
                pydio.UI.openComponentInModal('UserAccount', 'WelcomeModal', {
                    onRequestStart: function onRequestStart(skip) {
                        _this.discard('UserAccount.WelcomeModal.Shown');
                        if (skip) {
                            _this.discard();
                        } else {
        ...
        value: function discard() {
            var pref = arguments.length <= 0 || arguments[0] === undefined ? 'WelcomeComponent.Pydio8.TourGuide.Welcome' : arguments[0];
        ...
        value: function render() {
            ...
            if (widgetBarEnabled) {
                tourguideSteps.push({
                    ...
                    text: React.createElement(WidgetsCard, { message: message }),
...
},{"./apps/DlAppsCard":2,"./apps/QRCodeCard":4,"./board/HomeDashboard":7,"./quicksend/QuickSendCard":12,"./quicksend/WorkspacePickerDialog":13,"./recent/RecentAccessCard":14,"./videos/VideoCard":15,"./workspaces/WorkspacesListCard":17}],12:[function(require,module,exports){
(function (global){
/*
 * Copyright 2007-2017 Charles du Jeu - Abstrium SAS <team (at) pyd.io>
 * This file is part of Pydio.
...
},{"../board/Palette":9,"color":"color","material-ui":"material-ui","material-ui/styles":"material-ui/styles","pydio":"pydio","pydio/model/node":"pydio/model/node","react":"react"}],15:[function(require,module,exports){
(function (global){
/*
 * Copyright 2007-2017 Charles du Jeu - Abstrium SAS <team (at) pyd.io>
 * This file is part of Pydio.
